    ...
    <div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <div className="flex space-x-2">
          ...
          />
          <button onClick={handleAddGreeting} className="bg-secondary text-white px-4 py-2 rounded-lg hover:bg-emerald-600 transition-colors">Add</button>
        </div>
      </div>
        ...
        {isLoading ? <Spinner /> : (
          <div className="space-y-3">
            {greetings.map(greeting => (
              <div key={greeting.id} className="flex justify-between items-center p-3 bg-neutral-50 rounded-lg border">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button onClick={() => handleDeleteGreeting(greeting.id)} className="text-red-500 hover:text-red-700 p-1 rounded-full hover:bg-red-100 transition-colors">
